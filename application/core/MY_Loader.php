...
class MY_Loader extends CI_Loader
{
    ...
    public function template_login($template_name, $vars = array(), $return = FALSE)
    {
        if($return):
            $content  = $this->view('templates/login_header', $vars, $return);
            $content .= $this->view($template_name, $vars, $return);
            $content .= $this->view('templates/login_footer', $vars, $return);

            return $content;
        else:
            $this->view('templates/login_header', $vars);
            $this->view($template_name, $vars);
            $this->view('templates/login_footer', $vars);
        endif;
    }
}