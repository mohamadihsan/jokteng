    ...
    <footer class="footer">
      <div class="container-fluid">
        ...
        <div class="copyright float-right">
          ...
          </script>, Edited by <?= DEVELOPER_NAME ?> & Made by
          <a href="https://www.creative-tim.com" target="_blank"><?= TEMPLATE_BY ?></a>.
        </div>
        <!-- <div class="copyright float-right">
          &copy;
          <script>
  ...
  <script src="<?= base_url() ?>node_modules/datatables.net-dt/js/dataTables.dataTables.min.js"></script>
  <!-- <script src="<?= base_url() ?>node_modules/datatables.net-responsive-dt/js/responsive.dataTables.min.js"></script> -->
  <!-- <script src="<?= base_url() ?>node_modules/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script> -->
  <!-- <script src="<?= base_url() ?>node_modules/datatables.net-jqui/js/dataTables.jqueryui.min.js"></script> -->
  <script>
